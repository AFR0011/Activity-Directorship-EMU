...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
    ...
    const relatedEvents = await getRelatedEventsByCategory({ //YOU EITHER COMMENTED THIS SOMEWHERE, OR IT WAS NEVER IMPLEMENTED
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
                    ...
                    <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                        ...
                        <div className="flex flex-col gap-2">
                            <p className="p-bold-20 text-gray-600">What You'll Do:</p>
...
//Events with the same category
            <section className="wrapper my-8 flex flex-col gap-8 md:gap-12">
                ...
                <Collections data={relatedEvents?.data} emptyTitle="No Events Available" emptyStateSubtext="Come back later" collectionType="All_Events" limit={6} page={1} totalPages={2} />
            </section>
        </>
    )
}
